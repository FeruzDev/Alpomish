                    ...
                    <form className="d-flex align-items-center justify-content-center">
                        <div className="bg-white p-5 rounded-16">
                            ...
                            <div className="d-flex m-0">
                                <input type="text" className="border-bottom border-0 border-black_medium me-2 focus-none fs-20 text-black_dark text-center" style={{height: '36px', width: '36px'}} />
                                <input type="text" className="border-bottom border-0 border-black_medium me-2 focus-none fs-20 text-black_dark text-center" style={{height: '36px', width: '36px'}} />
                                <input type="text" className="border-bottom border-0 border-black_medium me-2 focus-none fs-20 text-black_dark text-center" style={{height: '36px', width: '36px'}} />
                                <input type="text" className="border-bottom border-0 border-black_medium me-2 focus-none fs-20 text-black_dark text-center" style={{height: '36px', width: '36px'}} />
                            </div>
                            <div className="form-check mt-4">
                                <input className="form-check-input focus-none" type="checkbox" defaultValue id="flexCheckChecked" defaultChecked />
                                <label className="form-check-label focus-none mt-1 ms-2 fw-light text-black_medium" htmlFor="flexCheckChecked">
                                    Запомнить на этом устройстве
                                </label>
                            </div>
                            <a href="#" className="text-blue_4 mt-4 text-decoration-none w-100 d-block">Отправить код повторно</a>
                            <a href="#" className="text-blue_4 mt-4 text-decoration-none w-100 d-block">Войти с другим номером</a>
                            <a href="#" className="text-grey mt-4 text-decoration-none w-100 d-block">Не получается войти</a>
                        </div>
                    </form>
                </div>
            </div>
