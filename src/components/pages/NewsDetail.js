                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-7">
                            <p className="fw-bold fs-40 text-blue_1">6 Strategies to Find Your Conference Keynote and Other Speakers</p>
                            <img src="images/news.png" className="w-100 rounded-20 mb-4" alt="news" />
                            <p className="fs-20 text-black_dark">
                                Ледниковый дворец Alpomish muz saroyi был построен в 18 декабря 2022 года а открытия ледникового
                                дворца для зрителей состоялась в 21 декабря 2022 года. Разработкой ледникого дворца занималась
                                компания OOO “NEW UNIVERSAL DEVELOPMENT” и вмешает в себя более 10 000 зрителей. На ледниковод
                                дворце Alpomish muz saroyi проводитца различные спортивне и развлекательные мероприятия а так же
                                есть спортвные секции для желающих заниматься спортом
                            </p>
                        </div>
                    </div>
                </div>
