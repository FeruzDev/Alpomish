                ...
                <div className="container">
                    <form className="d-flex align-items-center justify-content-center">
                        <div className="bg-white p-5 rounded-16">
                            ...
                            <input type="text" className="form-control border-white_light_1 rounded-8" placeholder="+998 (99) 999-99-99" />
                            <button className="btn login-btn w-100 mt-2" type="submit">Далее</button>
